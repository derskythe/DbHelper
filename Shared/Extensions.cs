...
public static class Extensions {
  ...
  public static DateTime GetDateTime<T>(this T source)
      where T : class {
    return source != DBNull.Value ? Convert.ToDateTime(source)
                                  : DateTime.MinValue;
  }
  ...
  public static string ToUpperCamelCase(this string value, bool cleanVar,
                                        bool manyType = false) {
  ...
  public static string ToLowerCamelCase(this string value, bool cleanVar,
                                        bool manyType = false) {
    if (string.IsNullOrEmpty(value)) {
      return string.Empty;
    }

    var s = cleanVar ? value.ToLowerInvariant().Split('_')
