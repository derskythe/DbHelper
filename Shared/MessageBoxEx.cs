...
public sealed class MessageBoxEx {
  ...
  /// </summary>
  /// <exception cref="NotSupportedException">multiple calls are not
  /// supported</exception> <autogeneratedoc />
  ...
  private static IntPtr MessageBoxHookProc(int nCode, IntPtr wParam,
    ...
    var msg =
        (CWPRETSTRUCT)(Marshal.PtrToStructure(lParam, typeof(CWPRETSTRUCT)) ??
  ...
  private static void CenterWindow(IntPtr hChildWnd) {
    ...
    var ptCenter = new Point(
        0, 0) { X = recParent.X + ((recParent.Width - recParent.X) / 2),
                Y = recParent.Y + ((recParent.Height - recParent.Y) / 2) };

    var ptStart = new Point(0, 0) { X = (ptCenter.X - (width / 2)),
