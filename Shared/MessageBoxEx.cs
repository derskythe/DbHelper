...
public sealed class MessageBoxEx
{
    ...
    /// <summary>
    /// Represents a callback function used with a Windows hook.
    /// </summary>
    /// <param name="nCode">The hook code that the hook procedure uses to determine how to process the message.</param>
    /// <param name="wParam">Additional information about the message. The exact meaning depends on the hook code.</param>
    /// <param name="lParam">Additional information about the message. The exact meaning depends on the hook code.</param>
    /// <returns>An IntPtr that provides additional information about the hook process or a value to pass on to the next hook procedure in the chain.</returns>
    /// <autogeneratedoc />
    ...
    /// </summary>
    /// <param name="hWnd">The handle to the window associated with the timer.</param>
    /// <param name="uMsg">The WM_TIMER message.</param>
    /// <param name="nIdEvent">The timer's identifier.</param>
    /// <param name="dwTime">The current system time, in milliseconds.</param>
    ...
    /// <summary>
    /// Moves the specified window to the given position and resizes it.
    /// </summary>
    /// <param name="hWnd">A handle to the window to move.</param>
    /// <param name="x">The new X-coordinate of the top-left corner of the window.</param>
    /// <param name="y">The new Y-coordinate of the top-left corner of the window.</param>
    /// <param name="nWidth">The new width of the window.</param>
    /// <param name="nHeight">The new height of the window.</param>
    /// <param name="bRepaint">Specifies whether the window should be repainted. Set to <c>true</c> to repaint the window; otherwise, <c>false</c>.</param>
    ...
    /// </summary>
    /// <param name="hWnd">Handle to the window whose window procedure will receive the message. If this parameter is <c>IntPtr.Zero</c>, the message is sent to all top-level windows in the system.</param>
    /// <param name="msg">Specifies the message to be sent.</param>
    /// <param name="wParam">Additional message-specific information.</param>
    /// <param name="lParam">Additional message-specific information.</param>
    /// <returns>A value of type <c>IntPtr</c> that specifies the result of the message processing; it depends on the message sent.</returns>
    /// <autogeneratedoc />
    [DllImport("User32.dll")]
