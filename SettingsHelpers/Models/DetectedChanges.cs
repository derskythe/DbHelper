...
public class DetectedChanges {
  ...
  /// </summary>
  /// <value><c>true</c> if this instance has values; otherwise,
  /// <c>false</c>.</value>
  ...
  public DetectedChanges(DifferenceType type, string path, string sourceValue,
                         string targetValue) {
  ...
  public DetectedChanges(string source, string path, string target,
                         bool hasValues) {
